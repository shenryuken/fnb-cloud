            ...
            @if($points_promo_is_enabled)
                <div class="flex flex-col gap-4">
                    <flux:field>
                        ...
                        <flux:input type="number" step="0.1" wire:model="points_promo_multiplier" placeholder="2" class="max-w-[140px]" />
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <flux:field>
                            ...
                            <flux:input type="datetime-local" wire:model="points_promo_starts_at" class="w-full" />
                        </flux:field>

                        <flux:field>
                            <flux:label>Ends At</flux:label>
                            <flux:input type="datetime-local" wire:model="points_promo_ends_at" class="w-full" />
                        </flux:field>
                    </div>
                </div>
            @endif
